            ...
            <div className="flex items-center justify-between gap-2 pt-1 border-t border-border/50">
              ...
              <div className="shrink-0">
                {(account as any).vipOnly ? (
                  <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/30 text-xs px-2 font-bold">
                    VIP
                  </Badge>
                ) : account.pointsCost === 0 ? (
                  <Badge className="bg-green-600/20 text-green-400 border-green-600/30 text-xs px-2">
                    Free
                  </Badge>
                ) : (
              ...
              <div className="flex items-center gap-2 min-w-0">
                <Avatar className="h-5 w-5 border border-border shrink-0">
                  ...
                  <AvatarFallback className="text-[9px] bg-secondary">
                    {(
                      account.posterUsername?.substring(0, 2) ?? "U"
                    ).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                {(() => {
